import bannerIMG from '../../../assets/urban_racing_3-ai.svg'
import './Banner.css'
    ...
    return (
        <div className='md:flex w-full my-20'>
            <div className='md:w-[50%] '>
                <h4 className="text-red-700 text-4xl font-extrabold px-4 md:p-0">NISSAN</h4>
                <h2 className='text-fuchsia-500 text-6xl font-extrabold mb-5 px-4 md:p-0'>SILVIA S15</h2>


                <p className='text-gray-500 px-4 md:p-0'>As a part of the Hot Wheels collection, the Nissan Silvia S15 is immortalized in miniature form, allowing fans to own and showcase this legendary car. Its attention to detail, vibrant colors, and high-quality craftsmanship make it a must-have for Hot Wheels collectors and fans of the Nissan Silvia.
